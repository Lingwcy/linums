...
export function ChatInputUI({
  ...
  const canSend = !!selectedModel && input.trim() && !isRecording && !isTranscribing
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-4xl px-6 py-4">
        ...
        {/* 统一的输入模块容器 */}
        <div className=" bg-background rounded-md p-3 shadow-[0_2px_8px_rgba(0,0,0,0.08)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.12)] transition-shadow">
          {/* 第一层：纯输入框 */}
          <form onSubmit={onSubmit} className="relative mb-2" id="chat-input-form">
            <input
              ...
              disabled={disabled}
              className="w-full h-12 bg-white dark:bg-gray-800 rounded-xl px-5 text-[15px] text-[hsl(var(--text-primary))] placeholder:text-[hsl(var(--text-secondary))] outline-none"
              autoComplete="off"
            />
          </form>
          ...
          <div className="flex items-center justify-between px-2">
            ...
            <div className="flex items-center gap-1">
              ...
              {/* 思考模式按钮 */}
              {!!selectedModel && selectedModelInfo?.supportsThinkingToggle && (
                <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button
