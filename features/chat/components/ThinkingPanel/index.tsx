...
export function ThinkingPanel({
  ...
  return (
    <div className="mb-4 border border-border/30 bg-muted/10 dark:bg-gray-900/30 rounded-md overflow-hidden transition-all duration-300">
      {/* 可折叠的标题栏 */}
      <button
      ...
      {/* 可折叠的内容区域 - 带动画过渡 */}
      <div
        className={`transition-all duration-50 ease-out ${isExpanded ? 'max-h-[500px] opacity-100' : 'max-h-0 opacity-0'
          }`}
      >
        <div
          ref={contentRef}
